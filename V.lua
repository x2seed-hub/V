...
ImageButton1.Image = "http://www.roblox.com/asset/?id="
...
H:AddLabel("Wellcone To Script บังอร Hub")

H:AddSeperator("Credit")



H:AddButton("Copy Youtube บังอร Hub",function()
setclipboard("")
end)
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=";
      Title = "บังอร Hub", 
      Text = "by noname hub and bring hub";
})
